      ...
      if (!collision) {
        ...
        if(this.frame==0){
          if(this.bot){
            ...
            binputs[1] = -this.tRex.yPos+93+(this.tRex.ducking?25:47);
            binputs[2] = -this.tRex.yPos + 93;
            try {
              binputs[3] = this.horizon.obstacles[0].xPos + 1 - 60;
              binputs[4] = this.horizon.obstacles[0].xPos + this.horizon.obstacles[0].typeConfig.width * this.horizon.obstacles[0].size - 1 - 60;
            ...
            try {
              binputs[7] = this.horizon.obstacles[1].xPos + 1 - 60;
              binputs[8] = this.horizon.obstacles[1].xPos + this.horizon.obstacles[1].typeConfig.width * this.horizon.obstacles[0].size - 1 - 60;
